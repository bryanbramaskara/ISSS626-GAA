...
![Source: <https://ifonlysingaporeans.blogspot.com/2013/02/land-use-plan.html>](images/clipboard-298876454.png)
...
anim_save("new_business_anim.gif", animation = anim)
```

![](new_business_anim.gif){fig-align="center"}
...
animate(
  ...
  renderer = gifski_renderer("lisa_restaurants.gif")
)
```

![](lisa_restaurants.gif)
...
animate(
  p,
  width = 960, height = 640, fps = 6, duration = 10, end_pause = 8,
  renderer = gifski_renderer("lisa_supermarkets.gif")
)
```

![](lisa_supermarkets.gif)
...
animate(
  p,
  width = 960, height = 640, fps = 6, duration = 10, end_pause = 8,
  renderer = gifski_renderer("lisa_softwaredevs.gif")
)
```

![](lisa_softwaredevs.gif)
